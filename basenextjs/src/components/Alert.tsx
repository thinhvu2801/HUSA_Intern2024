...
export const Alert: React.FC<TAlertProps> = ({
  ...
  const bindTitleClassname = classNames([
    {
      ...
      "text-[#175CD3]": (hierarchy === "secondary" ||  hierarchy === "tertiary" )&& color === "default", 
    },
    {
    ...
    },
    {
      ...
      "text-[#079455]": (hierarchy === "secondary" ||  hierarchy === "tertiary" ) && color === "success",
    },
  ]);
  ...
  const bindIconClassname = React.useMemo(() => {
      ...
      {isVisible && (
        <div className={ "flex " + bindClassname} >
          <div className={`py-1 h-full `}>
            <InfoCircle fill={bindIconClassname}/>
          </div>
          ...
          <div onClick={onClose} className={`py-1 h-full cursor-pointer `}>
            <XCloseIcon fill={bindIconClassname}/>
          </div>
        </div>
      )}
    </>
